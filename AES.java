...
deskey=KeyGenerator.getInstance("AES").generateKey();
 ...
 System.out.println("Original String:"+secstr);
 System.out.println("");
 System.out.println("Encrypted String:"+desencrypt);
 System.out.println("");
 System.out.println("Length of String:"+desdecp.length());
 System.out.println("");
 System.out.println("Length of String:"+desencrypt.length());
 System.out.println("");
 System.out.println("Decrypted String:"+desdecp);
 System.out.println("");
 }
 catch(Exception e)
 {
